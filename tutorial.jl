...
# ╔═╡ 120d5242-dde4-11ec-3d76-4f59744cc4d5
begin
...
# ╔═╡ d5077223-8991-4e59-b33c-0a5492afb5ec
begin
...
# ╔═╡ 6fa265c1-0799-430b-8744-db688a8a6de5
display(data);

# ╔═╡ b74bffa3-7226-4cb8-9501-0b7871a76f68
begin
	...
	plot(fit_km_1.times, fit_km_1.survival,label="Not Metastized")
	plot!(fit_km_2.times, fit_km_2.survival,label="Metastized")
end

# ╔═╡ 9c3782e3-e19d-437f-a5e2-bca0838d8d1a
...
# ╔═╡ a3b91ff5-7b44-42b9-b366-705f509c36aa
...
# ╔═╡ e19fa3fa-818a-4f2f-a0b2-d0155b83d877
begin
...
# ╔═╡ 9fada26c-c180-4d12-9926-e3ba6a6d6c67
begin
	# Sample using HMC.
    chain = sample(model, NUTS(0.65), MCMCThreads(), 4_000, 4)
    summaries, quantiles = describe(chain);
	plot(chain)
end

# ╔═╡ 0f296e73-8f7a-4a72-ba8b-2f25bf12584b
begin

	sim_time_post,sim_fit_post=simulate_survival_lognorm(sample(resetrange(chain), 1000),sym=Symbol("metastized[1]"))
	
	sim_time_post2,sim_fit_post2=simulate_survival_lognorm(sample(resetrange(chain), 1000),sym=Symbol("metastized[2]"))

    			sim_time_mean1,sim_fit_mean1=simulate_survival_lognorm(mean(chain),sym=Symbol("metastized[1]"))
    sim_time_mean2,sim_fit_mean2=simulate_survival_lognorm(mean(chain),sym=Symbol("metastized[2]"))

    plot( sim_time_post, sim_fit_post, xlabel="Time",ylabel="Survival",title="Posterior distribution",color=:blue4,alpha=0.05,label="")
    plot!(sim_time_post2,sim_fit_post2,label="",color=:red4,alpha=0.05)
	
    plot!(sim_time_mean1,sim_fit_mean1,label="Not metastized",color=:blue)
	plot!(fit_km_1.times, fit_km_1.survival,label="Not Metastized",color=:blue,linestyle=:dot,lw=2)
    plot!(sim_time_mean2,sim_fit_mean2,label="Metastized",color=:red)
	plot!(fit_km_2.times, fit_km_2.survival,label="Metastized",color=:red,linestyle=:dot,lw=2)
    #savefig("surv_posterior_lognorm.png")
end

# ╔═╡ 0c3b6ac3-ce93-4690-ae02-5a94354bafab
# play with weibull/gumbel distributions

# ╔═╡ 67dc495d-0c89-48bc-a8a0-3113f5e2a3c9
@model function survival_weibul(log_time, MetastizedNum, event)
    # priors 
    metastized ~ MvNormal([0, 0], 1.0)
	# prior scale
...
# ╔═╡ 38b444da-e521-4605-9c86-a027ee9894d2
model2 = survival_weibul(data.LogTimeS, data.MetastizedNum, data.Event) # , 1.0,0.1

# ╔═╡ a96b22a9-c973-41d1-b9ba-eda241e733cd
function simulate_survival_weibul(chain::Chains; sym=Symbol("metastized[1]"))
    # sample from chain
...
# ╔═╡ baa3924d-711b-4cc0-9c5f-e40d46263318
function simulate_survival_weibul(chain::ChainDataFrame; sym=Symbol("metastized[1]"))
    # sample from chain summary 
...
# ╔═╡ 47c7f78d-df63-4190-b64a-e9464d85e865
# Simulate prior
begin
    sim_time2,sim_fit2=simulate_survival_weibul(sample(model2, Prior(), 1000))
    plot( sim_time2, sim_fit2, xlabel="Time",ylabel="Survival",title="Prior distribution",color=:gray,legend = false,alpha=0.1)
end

# ╔═╡ cf2f1541-c39d-4e19-a193-ee1ece5639ab
begin
	# Sample using HMC.
...
# ╔═╡ c60c1e6e-3d8c-45b3-803c-fb7849e3560f
# show weibull fit
begin
    ...
    plot!(sim_time_mean3,sim_fit_mean3,label="Not metastized",color=:blue)
	plot!(fit_km_1.times, fit_km_1.survival,label="Not Metastized",color=:blue,linestyle=:dot,lw=2)
    plot!(sim_time_mean4,sim_fit_mean4,label="Metastized",color=:red)
	plot!(fit_km_2.times, fit_km_2.survival,label="Metastized",color=:red,linestyle=:dot,lw=2)
    #savefig("surv_posterior_lognorm.png")
end
...
begin
	# weibull
	plot(sim_time_mean3,sim_fit_mean3,label="Weibull Not metastized",color=:blue,linestyle=:dash,xlabel="Time",ylabel="Survival")
	plot!(sim_time_mean4,sim_fit_mean4,label="Weibull Metastized",color=:red,linestyle=:dash)

	# log-normal
	plot!(sim_time_mean1,sim_fit_mean1,label="LogNormal Not metastized",color=:blue,linestyle=:solid)
	plot!(sim_time_mean2,sim_fit_mean2,label="LogNormal Metastized",color=:red,linestyle=:solid)

	# non parametric
	plot!(fit_km_1.times, fit_km_1.survival,label="KM Not Metastized",color=:blue,linestyle=:dot,lw=2)
	plot!(fit_km_2.times, fit_km_2.survival,label="KM Metastized",color=:red,linestyle=:dot,lw=2)
end
...
git-tree-sha1 = "b5c7b1c4694b0ba44779c543ffa9a983d9e1893b"
...
git-tree-sha1 = "c4eb6030b5d5e15571d8dafd6026babbf8e27789"
...
git-tree-sha1 = "c7eecdeb63800fa818cb3655d0e5807911c40fbe"
